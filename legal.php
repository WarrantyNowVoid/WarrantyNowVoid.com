<?php
    ...
    $templateVars['pageTitle'] = 'Legal';
    $templateVars['contentType'] = 'system1';
    $templateVars['postURL'] = $JACKED->config->base_url . 'legal';
    $templateVars['postHeadline'] = 'All the legal stuff that\'s fit to ...electronically publish?';
...
?>
            ...
            <article>
                <h1>WNV Legal Department</h1>

                <img class="headliner topbar-system1" src="/assets/img/template/headliner_default.png" />

                <h1>Please read the following Terms and Conditions carefully</h1>
                <h2>...but we know you won't so here's the short version</h2>
                <p>By using WarrantyNowVoid.com, you agree that any submissions belong to us once we recieve them, and not to be a dick. Don't purposely offend or harm any other users of the site, don't try to break the site, and don't try to violate any laws via this site. All the content of the site is our property and we can do anything we want with it. If you think something on here belongs to you, let us know and we'll figure out what's going on. You're responsible for knowing your local laws, and if something we post isn't allowed where you are, that's your responsibility to avoid, to keep yourself out of trouble.</p>

                <p>We also promise that any information we collect about you is just to keep track of how the site is doing and to keep an eye on our demographics. We'll never sell or give out in any way any information we get from you, and we won't use it for any evil plots. </p>
                ...
                <br>
                <h3>User Conduct</h3>
                This Web Site and any communications service, including the capability to contribute material through the contribution form (each such submission, a 'Contribution') chat room, message board, newsgroup, or other interactive service that may be available to you on or through this site (collectively, the 'Services') are provided to you solely for entertainment purposes. By using the Web Site and Services you agree: (a) to provide true, accurate, current and complete information about yourself as prompted by the subscription form, contribution form and any registration form. If any information provided by you is untrue, inaccurate, not current or incomplete, WNV reserves the right to terminate your subscription and refuse any and all current or future use of the Services.<br>
                <br>
                Without limitation of the foregoing, <strong>you agree to not use the Web Site or Services to:</strong><br>
                <ul>
                <li>Upload, post, publish, e-mail, reproduce, distribute or otherwise <strong>transmit any Content that victimizes, harasses, degrades, or intimidates an individual or group of individuals on the basis of religion, gender, sexual orientation, race, ethnicity, age, or disability;</strong></li>
                <li>Upload, post, publish, e-mail, reproduce, distribute or otherwise transmit any information, data, text, music, sound, photographs, graphics, video, messages or other materials, including any Contribution, (collectively, 'Content'), that is unlawful, harmful, threatening, embarrassing, abusive, harassing, tortious, defamatory, vulgar, obscene, libelous, deceptive, fraudulent, contains explicit or graphic descriptions or accounts of sexual acts, invasive of another's privacy, or hateful;</li>
                <li>'Stalk' another;</li>
                <li>Harm minors in any way;</li>
                <li>Impersonate any person or entity, including, but not limited to, a WNV official, or falsely state or otherwise misrepresent your affiliation with a person or entity;</li>
                ...
                <br>
                You understand that the technical processing and transmission of the Web Site, including your Content, may involve (a) transmissions over various networks; and (b) changes to conform and adapt to technical requirements of connecting networks or devices. WNV assumes no responsibility for the deletion or failure to store postings, Contributions or other information submitted by you or other users to the Web Site.<br>
                <br>
                Any or all Content on the Web Site may be purged from time to time in WNV’s sole discretion. You acknowledge and agree that Content you view, submit or post is at your own discretion and risk, including any reliance on the accuracy, completeness, or usefulness of such Content. You acknowledge that you may not rely on any information, data, text, music, sound, photographs, graphics, video, messages or other materials created by WNV or submitted to WNV, including Content. You further acknowledge and agree that the views expressed on the Web Site do not necessarily reflect the views of WNV, and WNV does not support or endorse Content (including any Contribution, whether or not edited by WNV or its designee or presented on the Web Site edited or unedited, in whole or in part, or alone or with other content) posted or submitted by you or any User.<br>
                <br>

                <h3>Mobile / Wireless Policy</h3>
                In addition to any fee of which you are notified, your carrier’s standard messaging rates apply to our confirmation and all subsequent SMS correspondence. No more than two messages per day per SMS subscription will be sent. All charges are billed by and payable to your mobile service provider.<br>
                <br>
                We will not be liable for any delays in the receipt of any SMS messages, as delivery is subject to effective transmission from your network operator. SMS message services are provided on an AS IS basis.<br>
                <br>
                ...
                <br>
                Registered Users agree to release WNV and its agents, advertisers, sponsors or promotional partners, from all liability arising from participation in any of Game located on, or accessed through, the Web Site. WNV is not responsible for technical, hardware or software failures of any kind, lost or unavailable network connections, or failed, incomplete, garbled or delayed computer transmissions which may limit any Registered User’s ability to participate in any Game.<br>
                <br>
                Each Registered User agrees to be bound by the rules of any Game and by the rules of fair play and consideration of fellow Registered User. A Registered User who violates any of the rules or guidelines for behavior published on the Web Site, or the site where the Game is conducted, are subject to immediate disqualification and revocation of their registration. WNV is under no obligation to award any prize to any Registered User who violates a published rule or guideline.<br>

                <br>
                Some Games may offer prizes to Registered Users. All prizes are subject to the official game or contest rules published with that Game.<br>
                <br>
                WNV reserves the right to cancel, terminate or alter any Game or the rules thereof at any time without prior notification.<br>
                <br>
                <h3>Intellectual Property Rights</h3>
                All materials contained in this Web Site are the copyrighted property of WNV and its affiliates or licensors. As between WNV and you, WNV is the sole owner of all content on the Web Site, including without limitation, all applicable U.S. and non-U.S. copyrights, patents, trademarks, and trade secrets, and other intellectual property rights thereto. Except as otherwise specifically provided in these Terms and Conditions, you may not download or save a copy of the Web Site or any portion thereof, for any purpose. You may, however, print a copy of individual screens appearing as part of the Web Site solely for your personal, non-commercial use or records, provided that any marks, logos or other legends that appear on the copied screens remain on, and are not removed from the printed or stored images of such screens. All title and intellectual property rights in and to the content of the Linked Sites is the property of the respective content owner and may be protected by applicable copyright or other intellectual property laws and treaties.<br>
                <br>
                ...
                <br>
                We control and operate this site from our offices in Boston, Massachusetts. We do not represent that materials on the site are appropriate or available in all geographic locations, and accessing such from certain locations may be illegal and prohibited. Persons who choose to access this site from other locations do so on their own initiative, and we are not responsible for compliance with local laws or other applicable laws. You will not access the foregoing where prohibited by law.<br>
                <br>
                Any inquiries concerning these terms and conditions of use should be directed to our contact form.<br>
                <br>
                <h3>Provisions unenforceable or invalid</h3>
                If any part of this agreement is held invalid or unenforceable, that portion shall be construed in a manner consistent with applicable law to reflect, as nearly as possible, the original intentions of the parties, and the remaining portions shall remain in full force and effect.<br>
                <br>
                <h3>Assignment</h3>
                You shall not transfer, assign, sublicense nor pledge in any manner whatsoever, any of your rights or obligations under this Agreement. WNV may transfer, assign sublicense or pledge in any manner whatsoever, any of its rights and obligations under this agreement to a subsidiary, affiliate, or successor thereof or to any third party whatsoever, without notifying you or receiving your consent.<br>
                <br>
